...
@onready var cube_scene = preload("res://objects/blocks/blue/bluerightblock.tscn")
@onready var cube_scene_r = preload("res://objects/blocks/red/redrightblock.tscn")

# @onready var player = get_node("/root/XROrigin3D")
@onready var player2 = $%XROrigin3D as XROrigin3D
  # Replace with the actual path to your player node
# var cubes = []
